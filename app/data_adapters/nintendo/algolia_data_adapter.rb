...
module Nintendo
  class AlgoliaDataAdapter
    ...
    ATTRIBUTES = %i[
      title description external_id release_date release_date_display website_url boxart_url
      banner_url nsuid genres franchises developers publishers extra
    ].freeze
    ...
    def boxart_url
      url = data['boxart']
      url = "https://www.nintendo.com#{url}" if url.present? && url[0..3] != 'http'
      url
    end
