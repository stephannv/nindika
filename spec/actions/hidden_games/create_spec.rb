...
RSpec.describe HiddenGames::Create, type: :actions do
  describe 'Inputs' do
  ...
  describe 'Outputs' do
    ...
    it { is_expected.to include(hidden_game: { type: HiddenGame }) }
  end
  ...
  describe '#call' do
    ...
    context 'when attributes are valid' do
      ...
      it 'adds game to user hidden list' do
        result

        expect(user.hidden_list.exists?(id: game.id)).to eq true
      end
    end
    ...
    context 'when attributes are invalid' do
      ...
      it 'doesn`t add game to user hidden list' do
        result
